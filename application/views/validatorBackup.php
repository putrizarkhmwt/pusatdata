<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-check"></i> VALADASI MBR
        <small>List</small>
      </h1>
    </section>
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>validator/validatorListing" method="POST" id="searchList">
                            <div class="input-group">
                              <input type="text" name="searchText" class="form-control value="<?php echo $searchText; ?>" input-sm pull-right" style="width: 150px;" placeholder="Search"/>
