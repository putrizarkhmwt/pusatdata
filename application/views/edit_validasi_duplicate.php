              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-6">  
                                <h3 class="box-title"><strong>ID MBR : <?=$listS[0]->id_mbr?></strong></h3>
                            </div>
                            <div class="col-md-6">  
                    ...
                    <form role="form" id="addUser" action="<?=$this->config->base_url()?>validatorq/editDuplicate" method="post" enctype="multipart/form-data" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group" style="display: none;">
                                        <label>ID MBR</label>
                                        <input type="text" class="form-control required" value="<?=$listS[0]->id_mbr?>" id="id_mbr" name="id_mbr" maxlength="20" readonly />
                                    </div>
                                </div>
                                <div class="col-md-6">                                
                                    <div class="form-group" style="display: none;">
